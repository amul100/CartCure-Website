...
// ============================================================================
// WEB APP API ENDPOINT (for Power Automate integration)
// ============================================================================

/**
 * Web app endpoint for Power Automate to get client name by job number
 * This allows Power Automate to organize Outlook emails by client name
 *
 * Usage: GET https://script.google.com/.../exec?action=getClientName&jobNumber=J-TIGER-042
 * Returns: {"success": true, "jobNumber": "J-TIGER-042", "clientName": "John Smith"}
 *
 * Security: This endpoint only exposes client names for valid job numbers.
 * No sensitive financial or personal data is returned.
 *
 * @param {Object} e - Event object with query parameters
 * @returns {TextOutput} JSON response with client name
 */
function doGet(e) {
  try {
    const action = e.parameter.action;

    if (action === 'getClientName') {
      const jobNumber = e.parameter.jobNumber;
